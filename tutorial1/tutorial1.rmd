...
```{r}
# first we define a variable a - 3. Note that we use <- to assign values to variables. Using the = sign is also possible, but this can lead to confusion in other operations
a <- 3
